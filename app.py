...
UI_CHAT_TITLE = os.environ.get("UI_CHAT_TITLE") or "Finance Privacy Assistant"
UI_CHAT_DESCRIPTION = os.environ.get("UI_CHAT_DESCRIPTION") or " Start chatting with Finance Privacy Assistant"
UI_CHAT_DESCRIPTION_BELOW_SUB_TITLE = os.environ.get("UI_CHAT_DESCRIPTION_BELOW_SUB_TITLE") or "This chatbot provides information regarding privacy within Microsoft finance"
...
AZURE_SEARCH_SERVICE = os.environ.get("AZURE_SEARCH_SERVICE","financesearch3")
AZURE_SEARCH_INDEX = os.environ.get("AZURE_SEARCH_INDEX","index4-22-24")
AZURE_SEARCH_KEY = os.environ.get("AZURE_SEARCH_KEY", "gRyUt5XWGf80ElBT6qoYohv47gEkDobFjPqRMQdrXjAzSeAzIK1D")
...
AZURE_OPENAI_MODEL = os.environ.get("AZURE_OPENAI_MODEL","privacyassistantdeployment")
AZURE_OPENAI_ENDPOINT = os.environ.get("AZURE_OPENAI_ENDPOINT","https://privacyassistantResource.openai.azure.com/")
...
frontend_settings = { 
    ...
    "ui": {
        ...
        "chat_description_below_sub_title": UI_CHAT_DESCRIPTION_BELOW_SUB_TITLE,
...
def init_openai_client(use_data=SHOULD_USE_DATA):
    ...
    try:
        ...
        endpoint =  AZURE_OPENAI_ENDPOINT if AZURE_OPENAI_ENDPOINT else "https://{AZURE_OPENAI_RESOURCE}.openai.azure.com/"
