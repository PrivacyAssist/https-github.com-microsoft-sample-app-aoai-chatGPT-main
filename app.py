...
AZURE_SEARCH_SERVICE = os.environ.get("AZURE_SEARCH_SERVICE","privacyassistantsearch1")
AZURE_SEARCH_INDEX = os.environ.get("AZURE_SEARCH_INDEX","privacyassistantindex2-8-24")
